...
public class CategoryModel : BasePageModel
{
    ...
    public async Task<IActionResult> OnGetAsync()
    {
        ...
        ViewData["Keywords"] = $"{CategoryName.ToLower()}, diskuze {CategoryName.ToLower()}, diskuzi {CategoryName.ToLower()}, {CategoryCode}, èeská komunita, ceska komunita, discussion, fórum, forum";
