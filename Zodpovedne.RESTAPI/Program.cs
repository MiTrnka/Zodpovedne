    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddSingleton<Ganss.Xss.IHtmlSanitizer>(provider => {
                ...
                // PovolÌme iframe pro YouTube embedy
                ...
                // PovolÌme div pro ob·lku YouTube embedu
                ...
                // P¯ÌpadnÈ dalöÌ uûiteËnÈ povolenÌ pro CSS u embedding videÌ
                ...
                // P¯ÌpadnÈ dalöÌ uûiteËnÈ atributy pro iframe
                sanitizer.AllowedAttributes.Add("allow"); // ModernÌ alternativa k allowfullscreen
